...
public class VodServer extends Thread {
    ...
    int port = -1;
    public VodServer(Socket client, int port)
    {
        ...
        try {
            ...
            if (httpMethod.equals("GET")) {
                if (httpQueryString.equals("/")) {
                    ...
                    fileName = CONTENT_PATH +URLDecoder.decode(fileName);
    ...
    public void sendResponse (int statusCode, String responseString, boolean isFile, String range) throws Exception {
        ...
        if (isFile) {
            ...
            responseString = VodServer.HTML_START + responseString + VodServer.HTML_END;
    ...
    public static void main (String args[]) throws Exception {
        ...
        while(true) {
            ...
            (new VodServer(connected, port)).start();
        }
    }
}